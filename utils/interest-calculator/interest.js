/**
 * Simple/compound interest logic.
 *
 * The core math lives in `simpleInterest()` and `compoundInterest()`, pure
 * functions so they can be unit-tested without a DOM. The rest of this file
 * wires them up to the UI defined in index.html.
 */
...
if (typeof module !== "undefined" && module.exports) {
  module.exports = { simpleInterest, compoundInterest, formatCurrency };
}
...
if (typeof document !== "undefined") {
  ...
  function calculate() {
    ...
    const result =
      selectedMode() === "compound"
        ? compoundInterest(
            principal,
            rate,
            time,
            parseFloat(frequencyInput.value) || 1
          )
